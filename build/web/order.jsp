<%-- Página de Ordenes --%>
<%@page import="com.mycompany.arquitecturamvcclasses.LibrosBD"%>
<%@page contentType="text/html" pageEncoding="UTF-8"%>
<%@page session="true" import="java.util.*, com.mycompany.arquitecturamvc.*, com.mycompany.arquitecturamvcclasses.*" %>
...
<html>
	...
	<body>
		...
		<form name="AnyadirForm" action="shopping" method="POST">
			...
			Cantidad: <input type="number" name="cantidad" size="10" value="1">
