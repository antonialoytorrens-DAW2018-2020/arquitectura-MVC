package com.mycompany.arquitecturamvc;

import com.mycompany.arquitecturamvcclasses.ElementoPedido;
import com.mycompany.arquitecturamvcclasses.LibrosBD;
import java.io.*;
import java.util.*;
...
public class ServletControlador extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<ElementoPedido> elCarrito = (List<ElementoPedido>)session.getAttribute("carrito");
